...
<div class="max-w-7xl mx-auto space-y-6 pb-12">
    ...
    <div class="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-r from-cedar-950 via-cedar-900 to-cedar-800 text-white p-8 md:p-10 shadow-xl shadow-cedar-950/10">
        ...
        <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div class="space-y-2">
                <span class="inline-flex items-center px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-350 text-xs font-black uppercase tracking-wider">
    ...
    <div id="content-overview" class="tab-content space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-white p-6 rounded-[2rem] border border-cedar-100 shadow-md shadow-cedar-950/5 flex items-center justify-between">
                ...
                <div class="w-12 h-12 rounded-2xl bg-emerald-50 text-emerald-650 flex items-center justify-center">
            ...
            <div class="bg-white p-6 rounded-[2rem] border border-cedar-100 shadow-md shadow-cedar-950/5 flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-xl font-black text-cedar-955 mt-1 truncate max-w-[200px]" title="{{ Auth::user()->cellule->nomsection ?? 'Sans section' }}">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <!-- Left: Card Preview & Quick Access -->
            <div class="bg-white p-6 rounded-[2.5rem] border border-cedar-100 shadow-md shadow-cedar-950/5 space-y-6 flex flex-col justify-between">
                <div>
                    <h2 class="text-lg font-black text-cedar-950">Aperçu Carte de Membre</h2>
                    <p class="text-xs text-cedar-400 font-medium mt-1">Consultez et téléchargez votre carte de membre officielle.</p>
                </div>

                <div class="flex justify-center py-4">
                    <!-- Mini visual of card -->
                    <div class="w-56 h-36 rounded-2xl bg-gradient-to-br from-cedar-955 to-cedar-900 border border-cedar-500/20 p-4 text-white flex flex-col justify-between relative overflow-hidden shadow-lg">
                        <div class="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(219,182,150,0.1),transparent_70%)] pointer-events-none"></div>
                        <div class="flex items-center gap-2 border-b border-white/10 pb-1.5 z-10">
                            <div class="w-6 h-6 bg-emerald-500/10 rounded-md flex items-center justify-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 text-emerald-350" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                                </svg>
                            </div>
                            <span class="text-[9px] font-black text-emerald-300 uppercase tracking-widest">SunuDaara</span>
                        </div>
                        <div class="z-10">
                            <p class="text-xs font-black uppercase truncate">{{ Auth::user()->prenom }} {{ Auth::user()->nom }}</p>
                            <p class="text-[8px] text-emerald-300 font-mono mt-0.5">{{ Auth::user()->matricule ?? 'SD-0000' }}</p>
                        </div>
                    </div>
                </div>

                <button onclick="switchTab('profile-card')" class="w-full py-3.5 bg-cedar-900 hover:bg-cedar-950 text-white text-xs font-black rounded-2xl shadow-lg shadow-cedar-950/10 transition-all flex items-center justify-center gap-2">
            ...
            <div class="lg:col-span-2 bg-white p-6 rounded-[2.5rem] border border-cedar-100 shadow-md shadow-cedar-950/5 flex flex-col justify-between">
                <div>
                    <div class="flex items-center justify-between">
                        ...
                        <button onclick="openCotiserModal()" class="px-5 py-2.5 bg-emerald-650 hover:bg-emerald-700 text-white text-xs font-black rounded-xl shadow-md shadow-cedar-900/10 transition-all flex items-center gap-1.5">
                                ...
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 rounded-xl bg-cedar-100 text-cedar-800 flex items-center justify-center">
                                        ...
                                        @elseif($cot->methodepayement === 'free_money')
                                            <span class="font-black text-xs text-red-650">F</span>
                                        @else
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-cedar-650" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="border-t border-cedar-50 pt-4 mt-6">
                    <button onclick="switchTab('contributions')" class="text-xs font-black text-cedar-850 hover:text-cedar-950 flex items-center gap-1 transition-colors">
    ...
    <div id="content-profile-card" class="tab-content hidden space-y-6">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div class="flex flex-col items-center gap-6 bg-white p-6 rounded-[2.5rem] border border-cedar-100 shadow-xl shadow-cedar-950/5">
                <h2 class="text-lg font-black text-cedar-950 self-start px-2">Ma Carte Officielle</h2>
                
                <!-- Card Render Container -->
                <div id="member-card-render" class="w-[320px] h-[480px] rounded-[2rem] relative overflow-hidden shadow-2xl border-2 border-emerald-500/30 flex flex-col justify-between p-6 sidebar-gradient text-white select-none">
                    <!-- Background Design elements -->
                    <div class="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(219,182,150,0.16),transparent_60%)] pointer-events-none"></div>
                    <div class="absolute -bottom-16 -right-16 w-48 h-48 rounded-full bg-cedar-400/5 blur-3xl pointer-events-none"></div>
                    
                    <!-- Card Header -->
                    <div class="flex items-center gap-3 border-b border-white/10 pb-4 z-10">
                        ...
                        <div>
                            <h4 class="text-xs font-black tracking-widest text-emerald-400 uppercase leading-none">SunuDaara</h4>
                            <p class="text-[9px] text-cedar-300 uppercase font-black tracking-widest leading-none mt-1">Carte de membre</p>
                        </div>
                    </div>

                    <!-- Card Body -->
                    <div class="flex flex-col items-center gap-3 my-auto z-10">
                        <!-- Dynamic Avatar -->
                        <div class="w-24 h-24 rounded-full border-4 border-emerald-500/20 p-1 bg-cedar-950 shadow-xl overflow-hidden flex items-center justify-center">
                            <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->prenom . ' ' . Auth::user()->nom) }}&background=f5ebdf&color=3c1f19&bold=true&size=128" alt="Avatar" class="w-full h-full rounded-full object-cover">
                        </div>

                        <!-- User Name -->
                        <div class="text-center">
                            <h2 class="text-lg font-black tracking-wide text-white leading-tight uppercase">
                                {{ Auth::user()->prenom }} {{ Auth::user()->nom }}
                            </h2>
                            <span class="inline-block px-3 py-0.5 bg-emerald-600 text-white text-[9px] font-black rounded-full uppercase mt-1 tracking-wider">
                                {{ Auth::user()->role === 'admin' ? 'Administrateur' : (in_array(Auth::user()->role, ['responsable', 'responsble']) ? 'Responsable' : 'Membre') }}
                            </span>
                        </div>

                        <!-- Card details block -->
                        <div class="w-full bg-white/5 border border-white/10 rounded-2xl p-4 space-y-2 mt-2 text-xs font-medium">
                            <div class="flex justify-between border-b border-white/5 pb-1.5">
                                <span class="text-cedar-300 text-[10px] uppercase tracking-wider font-bold">Matricule</span>
                                <span class="font-black text-emerald-400 font-mono">{{ Auth::user()->matricule ?? 'Non assigné' }}</span>
                            </div>
                            <div class="flex justify-between border-b border-white/5 pb-1.5">
                                <span class="text-cedar-300 text-[10px] uppercase tracking-wider font-bold">Section</span>
                                <span class="font-black text-white truncate max-w-[120px]">{{ Auth::user()->cellule->nomsection ?? 'Sans Section' }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-cedar-300 text-[10px] uppercase tracking-wider font-bold">Depuis le</span>
                    ...
                    <div class="border-t border-white/10 pt-4 flex flex-col items-center gap-2 z-10">
                        <div class="flex items-center justify-center gap-[2px] h-6 bg-white/95 px-4 py-1.5 rounded-lg w-full">
                        ...
                        <p class="text-[8px] text-cedar-300 uppercase tracking-widest font-black">Vérification de sécurité</p>
                    </div>
                </div>

                <button onclick="downloadMyCard()" class="w-full py-3.5 bg-cedar-900 hover:bg-cedar-950 text-white text-xs font-black rounded-2xl shadow-xl shadow-cedar-950/10 transition-all flex items-center justify-center gap-2">
            ...
            <div class="lg:col-span-2 bg-white p-8 rounded-[2.5rem] border border-cedar-100 shadow-xl shadow-cedar-950/5 space-y-6">
                <div class="border-b border-cedar-50 pb-4">
                    <h2 class="text-xl font-black text-cedar-955">Informations de Profil</h2>
                    <p class="text-xs text-cedar-450 mt-0.5">Détails de votre fiche d'inscription officielle.</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2 border-t border-cedar-50 pt-4 mt-2">
                        <h3 class="text-xs font-black text-cedar-955 uppercase tracking-widest mb-3">Statut & Activité</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="bg-cedar-50/20 p-4 rounded-2xl border border-cedar-50/50">
    ...
    <div id="content-events" class="tab-content hidden space-y-8">
        ...
        <div class="space-y-4">
            <div class="flex items-center justify-between border-b border-cedar-50 pb-2">
                ...
                <span class="px-3 py-1 bg-cedar-100 text-cedar-855 text-xs font-black rounded-lg uppercase">
                ...
                @forelse($evenementsCommunaute as $event)
                    ...
                    <div class="bg-white p-6 rounded-[2.2rem] border border-cedar-100 shadow-md shadow-cedar-950/5 space-y-4 flex flex-col justify-between">
                        <div class="space-y-3">
                            ...
                            <h3 class="text-lg font-black text-cedar-955 leading-tight">{{ $event->libelleevent ?? $event->numeroevent }}</h3>

                            <!-- Dates -->
                            <div class="flex items-center gap-4 text-xs text-cedar-450 font-semibold bg-cedar-50/50 p-2.5 rounded-xl border border-cedar-100/30">
                        ...
                        @if($userParticipation)
                            ...
                            <div class="space-y-1.5 pt-2 border-t border-cedar-100/50">
                                ...
                                <div class="w-full bg-cedar-100 h-2 rounded-full overflow-hidden relative">
                                    <div class="bg-gradient-to-r from-emerald-400 to-emerald-650 h-full rounded-full transition-all duration-500" style="width: {{ $indivPercentage }}%"></div>
                                </div>
                                <div class="flex justify-between items-center text-[10px] font-bold text-cedar-400">
                                    ...
                                    <span class="text-emerald-650 font-extrabold">{{ $indivPercentage }}% versé</span>
                                </div>
                            </div>

                            @if($event->statut !== 'termine')
                                <button onclick="openCotiserModal({{ $event->id }})" class="w-full py-3.5 bg-emerald-650 hover:bg-emerald-700 text-white text-xs font-black rounded-2xl shadow-lg shadow-cedar-900/10 transition-all flex items-center justify-center gap-1.5 mt-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4.5 w-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                    Cotiser pour cet événement
                                </button>
                            @else
                        ...
                        @else
                            @if($event->statut !== 'termine')
                                <button onclick="openEngagementModal({{ $event->id }}, '{{ addslashes($event->libelleevent ?? $event->numeroevent) }}')" class="w-full py-3.5 bg-cedar-900 hover:bg-cedar-950 text-white text-xs font-black rounded-2xl shadow-lg shadow-cedar-950/10 transition-all flex items-center justify-center gap-1.5 mt-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4.5 w-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
                                    </svg>
                                    S'engager sur cet événement
                                </button>
                            @else
                                <button disabled class="w-full py-3.5 bg-cedar-100 text-cedar-400 text-xs font-black rounded-2xl flex items-center justify-center gap-1.5 cursor-not-allowed mt-4">
                                    Événement Clôturé
        ...
        <div class="space-y-4 pt-4">
            <div class="flex items-center justify-between border-b border-cedar-50 pb-2">
                ...
                <span class="px-3 py-1 bg-emerald-100 text-emerald-850 text-xs font-black rounded-lg uppercase">
    ...
    <div id="content-contributions" class="tab-content hidden space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-gradient-to-br from-cedar-800 to-cedar-955 text-white p-6 rounded-3xl shadow-lg shadow-cedar-900/10 flex items-center justify-between">
                <div>
        ...
        <div class="bg-white p-6 rounded-[2.5rem] border border-cedar-100 shadow-md shadow-cedar-950/5 space-y-4">
                    ...
                    <tbody class="divide-y divide-cedar-50/50 font-bold text-sm text-cedar-950">
                        @forelse($cotisations as $cot)
                            <tr class="hover:bg-cedar-50/10 transition-colors">
                                <td class="p-4 font-mono text-xs text-cedar-550">{{ $cot->numerocontributions }}</td>
...
<div id="cotisation-modal" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm hidden animate-fade-in">
    <div class="bg-white rounded-[2.5rem] w-full max-w-lg border border-cedar-100 shadow-2xl overflow-hidden flex flex-col justify-between max-h-[90vh]">
        <!-- Modal Header -->
        <div class="px-6 py-5 bg-cedar-950 text-white flex items-center justify-between">
            <div class="flex items-center gap-2">
                <div class="w-8 h-8 rounded-lg bg-emerald-500/10 flex items-center justify-center border border-emerald-500/20">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4.5 w-4.5 text-emerald-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <form id="cotisation-form" method="POST" action="{{ route('membre.cotisations.store') }}" class="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            <div id="modal-step-2" class="space-y-5 hidden">
                ...
                <div class="grid grid-cols-1 gap-3">
                    ...
                    <div class="relative">
                        ...
                        <label for="pay_method_wave" class="flex items-center justify-between p-4 bg-white border-2 border-cedar-100 hover:border-blue-300 rounded-2xl cursor-pointer transition-all hover:bg-slate-50/50 peer-checked:border-blue-500 peer-checked:bg-blue-50/20 group">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-xl bg-blue-50 text-blue-650 flex items-center justify-center font-black text-sm border border-blue-200">
                                    W
                                </div>
                                <div>
                    ...
                    <div class="relative">
                        ...
                        <label for="pay_method_om" class="flex items-center justify-between p-4 bg-white border-2 border-cedar-100 hover:border-orange-300 rounded-2xl cursor-pointer transition-all hover:bg-slate-50/50 peer-checked:border-orange-500 peer-checked:bg-orange-50/20 group">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-xl bg-orange-50 text-orange-655 flex items-center justify-center font-black text-xs border border-orange-200">
                                    OM
                                </div>
                                <div>
                    ...
                    <div class="relative">
                        ...
                        <label for="pay_method_free" class="flex items-center justify-between p-4 bg-white border-2 border-cedar-100 hover:border-red-350 rounded-2xl cursor-pointer transition-all hover:bg-slate-50/50 peer-checked:border-red-500 peer-checked:bg-red-50/20 group">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-xl bg-red-50 text-red-750 flex items-center justify-center font-black text-xs border border-red-200">
                                    FM
                                </div>
                                <div>
                            ...
                            <div class="w-5 h-5 rounded-full border-2 border-cedar-200 group-hover:border-red-400 peer-checked:bg-red-650 peer-checked:border-red-650 flex items-center justify-center transition-all">
                                <div class="w-2 h-2 rounded-full bg-white scale-0 peer-checked:scale-100 transition-transform"></div>
                            </div>
                        </label>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <label for="pay_method_bank" class="flex items-center justify-between p-4 bg-white border-2 border-cedar-100 hover:border-cedar-400 rounded-2xl cursor-pointer transition-all hover:bg-slate-50/50 peer-checked:border-cedar-900 peer-checked:bg-cedar-50/30 group">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-xl bg-cedar-50 text-cedar-850 flex items-center justify-center border border-cedar-200">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
                                    </svg>
                                </div>
                                <div>
                                    <span class="block font-black text-sm text-cedar-955">Virement ou Carte Bancaire</span>
                                    <span class="block text-[10px] text-cedar-400 font-semibold mt-0.5">Pour les montants plus importants</span>
                                </div>
                            </div>
                            <div class="w-5 h-5 rounded-full border-2 border-cedar-200 group-hover:border-cedar-650 peer-checked:bg-cedar-900 peer-checked:border-cedar-900 flex items-center justify-center transition-all">
                                <div class="w-2 h-2 rounded-full bg-white scale-0 peer-checked:scale-100 transition-transform"></div>
                            </div>
                        </label>
                    </div>
                ...
                <div class="flex gap-3 pt-4 border-t border-cedar-50">
                    <button type="button" onclick="goToStep(1)" class="w-1/3 py-4 bg-cedar-100 hover:bg-cedar-200 text-cedar-955 text-xs font-black rounded-2xl transition-all">
                        Retour
                    </button>
            ...
            <div id="modal-step-3" class="hidden flex flex-col items-center justify-center py-16 space-y-4 text-center">
                <div class="w-16 h-16 rounded-full bg-cedar-50 flex items-center justify-center text-cedar-950 relative mb-2">
                    <!-- Spinner / Load -->
                    <div id="carrier-loader" class="absolute inset-0 rounded-full border-4 border-cedar-100 border-t-emerald-650 animate-spin"></div>
        ...
        <div class="px-6 py-5 bg-cedar-950 text-white flex items-center justify-between">
            <div class="flex items-center gap-2">
                <div class="w-8 h-8 rounded-lg bg-amber-400/20 flex items-center justify-center border border-amber-400/40">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4.5 w-4.5 text-amber-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
